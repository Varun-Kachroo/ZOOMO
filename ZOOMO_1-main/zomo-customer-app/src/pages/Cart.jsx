...
export default function Cart() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:C.page, paddingBottom:32,
      fontFamily:"'Satoshi', system-ui, sans-serif" }}>
      ...
      <div style={{ maxWidth:680, margin:"0 auto", padding:"28px 20px" }}>
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:10, marginBottom:20 }}>
          {cart.items.map(item => (
            <div key={item.id} style={{ display:"flex", alignItems:"center", gap:14, padding:14,
              ...
              <div style={{ flex:1, minWidth:0 }}>
                <h3 style={{ fontWeight:600, fontSize:14, color:C.textMain,
                  overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>{item.dish?.name}</h3>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:8, flexShrink:0 }}>
                <button onClick={() => decreaseQuantity(item)}
                  style={{ width:28, height:28, borderRadius:9, background:C.page, border:`1px solid ${C.border}`,
                ...
                <button onClick={() => increaseQuantity(item)}
                  style={{ width:28, height:28, borderRadius:9, background:C.primary, border:"none",
                    display:"flex", alignItems:"center", justifyContent:"center", color:"#fff", cursor:"pointer" }}>
                  <Icon.Plus />
                </button>
              </div>
              <button onClick={() => removeItem(item.id)}
                style={{ padding:8, background:"none", border:"none", color:C.textMuted,
        ...
        {/* Bill */}
        <div style={{ padding:20, borderRadius:20, background:C.surface, border:`1px solid ${C.border}`,
          marginBottom:20 }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:9 }}>
            ...
            <div style={{ borderTop:`1px solid ${C.borderSoft}`, paddingTop:12, marginTop:3,
